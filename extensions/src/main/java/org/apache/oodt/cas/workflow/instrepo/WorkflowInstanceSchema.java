 ...
 *
 * <p>The workflow instance repository is a database, and DRAT has no
 ...
 * duplicated rather than shared because it lives in application repos rather
 * than in Mnemosyne. Promote it and delete the copies.
 */
